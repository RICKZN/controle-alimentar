<template>
  <div class="app-layout" :class="{ 'sidebar-open': isSidebarOpen }">
    ...
    <main class="main-content">
      ...
      <div class="content-area">
        ...
        <div v-if="currentTab === 'validacao'" class="tab-pane">
          <div class="scanner-wrapper card glass-effect">
            <div class="scanner-header">
              <p v-if="!isCameraActive" class="camera-info">
                A câmera está desligada
              </p>

              <p v-else class="camera-info active">
                Buscando QR Code...
              </p>
            </div>
            ...
            <div class="preview-container">
              ...
              <div v-if="matriculaLida" class="scan-success-overlay">
                <div class="success-card">
                  ...
                  <button @click="resetScan" class="btn-link">
                    Cancelar
                  </button>
                </div>
              </div>
            ...
            <div class="scanner-controls">
              <button
                ...
                :class="[
                  'btn',
                  isCameraActive ? 'btn-danger' : 'btn-success'
                ]"
              >
                {{
                  isCameraActive
          ...
          >
            ...
            <p v-if="tempoEsperaReal" class="wait-time">
              ⏳ {{ tempoEsperaReal }}
            </p>
          </div>
          ...
          <div class="card glass-effect">
            ...
            <div class="input-group-row">
              <input
                ...
                @keyup.enter="validarFicha(matriculaParaValidar)"
              />

              <button
                @click="validarFicha(matriculaParaValidar)"
        ...
        <div v-if="currentTab === 'alunos'" class="tab-pane">
          ...
          <div class="card glass-effect">
            ...
            <div class="table-wrapper">
              ...
              >
                <p>
                  Nenhum aluno encontrado. Cadastre o primeiro aluno
                  no formulário acima!
                </p>
              </div>
              ...
              <div class="table-header">
                ...
                <div style="display:flex; gap:8px">
                  <button
                    ...
                    class="btn-refresh"
                    title="Normaliza nomes e reconsolida o estoque, eliminando cards duplicados do mesmo alimento"
                  >
                    🔧 Corrigir duplicados
                  </button>
              ...
              >
                ...
                <div class="item-body">
                  <button
                    ...
                    @click="ajustarEstoque(item.id, -1)"
                  >
                    −
                  </button>
        ...
        <div v-if="currentTab === 'prato'" class="tab-pane">
          ...
          <!-- Histórico de pratos AGORA DENTRO de Prato do Dia -->
          <div
                  ...
                  >
                    ...
                    <td>
                      ...
                      >
                        ...
                        <span
                          v-if="i < p.ingredientes.length - 1"
                        >
                          ,
                        </span>
                      </span>
                    ...
                    <td>
                      <button
                        @click="excluirPratoHistorico(p.id)"
                        class="btn-icon-delete"
                      >
                        🗑️
                      </button>
        ...
        <div v-if="currentTab === 'alertas'" class="tab-pane">
          ...
          <div class="dashboard-grid">
            ...
            <div class="card glass-effect alert-card">
              ...
              <p>
                Prato:
                {{ alertas.pratoDoDia?.nome || 'Não registrado' }}
              </p>

              <p>
                Refeições liberadas:
                {{ alertas.refeicoesLiberadasHoje || 0 }}
              </p>
              ...
              <p>
                ...
                {{
                  formatarQuantidade(
                    alertas.alimentosUtilizadosHoje || 0
                  )
                }}
              </p>
            </div>
    ...
    <div
      ...
      class="modal-overlay"
      @click.self="alimentoSelecionado = null"
    >
      <div class="modal-box modal-wide">
        <h3>
          Lotes de {{ alimentoSelecionado }}
        </h3>
        ...
        <button
          @click="alimentoSelecionado = null"
          class="btn btn-secondary"
        >
          Fechar
        </button>
    ...
    <div
      ...
      class="modal-overlay"
      @click.self="loteParaAdicionar = null"
    >
      <div class="modal-box">
        <h3>
          Adicionar Lote —
